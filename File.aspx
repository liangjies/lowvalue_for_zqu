<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="File.aspx.cs" Inherits="WebApplication1.File" %>
                    ...
                    <tr>
                        <td style="background-image: url(images/nv.jpg); height: 20px; text-align: left;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; width: 100%; height: 20px">
                                <tr>
                                    <td style="text-align: left; width: 300px"><a href="./" style="text-decoration: none;">首页>>文件下载</a> </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
